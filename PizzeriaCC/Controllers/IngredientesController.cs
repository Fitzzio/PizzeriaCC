...
namespace PizzeriaCC.Controllers
{
    public class IngredientesController : Controller
    {
        ...
        public IngredientesController(PizzeriaBdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,PrecioExtra")] Ingrediente ingrediente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,PrecioExtra")] Ingrediente ingrediente)
        {
